...
const Detail = () => {
  ...
  //         STATE / ESTADO
  const [data, setData] = useState<Data>({} as Data);//Mr roboto 
  ...
  function handleComposerMail(){
    MailComposer.composeAsync({
      subject: 'Interesse na coleta residuos',
      recipients: [data.point.email]
    });
  }

  function handleWhatasapp(params:type) {
    Linking.openURL(`whatasapp://send?phone=${data.point.whatsapp}`)
  }

  if(!data.point){
    return null; //should return a loading screen
  }
